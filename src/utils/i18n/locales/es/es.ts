export const esLang = {
  ...
  'faq': {
    ...
    'answer-5': 'No, no estamos siendo pagados. Aunque esta plataforma es de uso gratuito y no hay obligación de pagar, si quieres apoyar este proyecto y ayudar a cubrir los costos del servidor y del DNS, puedes enviarnos unos cuantos dólares a través de PayPal a mpstinis@gmail.com o echar un vistazo a la música de MS en https://naegleria.bandcamp.com/.',
